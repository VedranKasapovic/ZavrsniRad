...
public class ProzorOdgovornaOsoba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstDjecaUBazi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lstDjecaUBaziMouseClicked(evt);
            }
        });
    ...
    private void lstDjecaUBaziMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstDjecaUBaziMouseClicked
        if (evt.getClickCount() != 2) {
            return;
        }
        dodajDijete();
    }//GEN-LAST:event_lstDjecaUBaziMouseClicked
